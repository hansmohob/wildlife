...
fix_image_upload() {
    ...
    aws iam attach-role-policy \
        ...
        --policy-arn arn:aws:iam::REPLACE_AWS_ACCOUNT_ID:iampolicy/REPLACE_PREFIX_CODE-iampolicy-application-data
...
create_efs_storage() {
    ...
    if ! aws iam list-attached-role-policies \
        --role-name REPLACE_PREFIX_CODE-iamrole-ecs-task \
        --query 'AttachedPolicies[?PolicyArn==`arn:aws:iam::REPLACE_AWS_ACCOUNT_ID:iampolicy/REPLACE_PREFIX_CODE-iampolicy-application-data`]' \
